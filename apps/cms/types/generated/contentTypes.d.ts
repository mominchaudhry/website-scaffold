...
export interface ApiSiteConfigSiteConfig extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    defaultTheme: Schema.Attribute.Relation<'oneToOne', 'api::theme.theme'>;
...
export interface ApiThemeTheme extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    spacing: Schema.Attribute.Component<'theme.spacing', false> &
      Schema.Attribute.Required;
    radius: Schema.Attribute.Component<'theme.radius', false> &
      Schema.Attribute.Required;
    shadow: Schema.Attribute.Component<'theme.shadow', false> &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
